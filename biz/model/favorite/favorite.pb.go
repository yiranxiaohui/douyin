...
type DouyinFavoriteActionRequest struct {
	...
	ActionType int32  `protobuf:"varint,3,opt,name=action_type,json=actionType,proto3" json:"action_type" form:"action_type" query:"action_type"` // 1-点赞，2-取消点赞
}
...
type DouyinFavoriteListResponse struct {
	...
	StatusCode int32        `protobuf:"varint,1,opt,name=status_code,json=statusCode,proto3" json:"status_code" form:"status_code" query:"status_code"` // 状态码，0-成功，其他值-失败
	StatusMsg  string       `protobuf:"bytes,2,opt,name=status_msg,json=statusMsg,proto3" json:"status_msg" form:"status_msg" query:"status_msg"`       // 返回状态描述
	VideoList  []*api.Video `protobuf:"bytes,3,rep,name=video_list,json=videoList,proto3" json:"video_list" form:"video_list" query:"video_list"`                 // 用户点赞视频列表
}
...
func (x *DouyinFavoriteListResponse) GetVideoList() []*api.Video {
	if x != nil {
		return x.VideoList
	}
	return nil
...
var file_favorite_proto_rawDesc = []byte{
	...
	0x69, 0x72, 0x73, 0x74, 0x1a, 0x09, 0x61, 0x70, 0x69, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22,
	0x72, 0x0a, 0x1e, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69,
	...
	0x79, 0x70, 0x65, 0x22, 0x61, 0x0a, 0x1f, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f, 0x66, 0x61,
	...
	0x74, 0x75, 0x73, 0x4d, 0x73, 0x67, 0x22, 0x4d, 0x0a, 0x1c, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e,
	...
	0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x8a, 0x01, 0x0a, 0x1d, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e,
	0x5f, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x5f, 0x72,
	...
	,
	...
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x32, 0xa6, 0x01, 0x0a, 0x13, 0x46, 0x61, 0x76, 0x6f, 0x72, 0x69,
	0x74, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x8e, 0x01,
	0x0a, 0x0c, 0x46, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x30,
	0x2e, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x2e, 0x65, 0x78, 0x74, 0x72, 0x61, 0x2e, 0x66, 0x69,
	0x72, 0x73, 0x74, 0x2e, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f, 0x66, 0x61, 0x76, 0x6f, 0x72,
	...
	0x2f, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x2f, 0x6c, 0x69, 0x73, 0x74, 0x42, 0x1b,
	0x5a, 0x19, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x2f, 0x62, 0x69, 0x7a, 0x2f, 0x6d, 0x6f, 0x64,
	0x65, 0x6c, 0x2f, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_favorite_proto_depIdxs = []int32{
	4, // 0: douyin.extra.first.douyin_favorite_list_response.video_list:type_name -> api.Video
	0, // 1: douyin.extra.first.FavoriteActionService.FavoriteAction:input_type -> douyin.extra.first.douyin_favorite_action_request
	2, // 2: douyin.extra.first.FavoriteListService.FavoriteList:input_type -> douyin.extra.first.douyin_favorite_list_request
	1, // 3: douyin.extra.first.FavoriteActionService.FavoriteAction:output_type -> douyin.extra.first.douyin_favorite_action_response
	3, // 4: douyin.extra.first.FavoriteListService.FavoriteList:output_type -> douyin.extra.first.douyin_favorite_list_response

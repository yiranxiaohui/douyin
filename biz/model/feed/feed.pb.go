...
type DouyinFeedResponse struct {
	...
	VideoList  []*api.Video `protobuf:"bytes,3,rep,name=video_list,json=videoList" json:"video_list" form:"video_list" query:"video_list"`                                  // 视频列表
...
var file_feed_proto_rawDesc = []byte{
	...
	0x65, 0x6c, 0x2f, 0x66, 0x65, 0x65, 0x64,
}

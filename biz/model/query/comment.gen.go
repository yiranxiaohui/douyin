...
func newComment(db *gorm.DB, opts ...gen.DOOption) comment {
	...
	_comment.CreateDate = field.NewInt64(tableName, "create_date")
...
type comment struct {
	...
	ID         field.Int64  // 评论id
	Text       field.String // 评论内容
	CreateDate field.Int64  // 提交时间
...
func (c *comment) updateTableName(table string) *comment {
	...
	c.CreateDate = field.NewInt64(table, "create_date")

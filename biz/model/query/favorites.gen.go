...
func newFavorite(db *gorm.DB, opts ...gen.DOOption) favorite {
	...
	_favorite.favoriteDo.UseModel(&orm_gen.Favorite{})
...
type IFavoriteDo interface {
	...
	Create(values ...*orm_gen.Favorite) error
	CreateInBatches(values []*orm_gen.Favorite, batchSize int) error
	Save(values ...*orm_gen.Favorite) error
	First() (*orm_gen.Favorite, error)
	Take() (*orm_gen.Favorite, error)
	Last() (*orm_gen.Favorite, error)
	Find() ([]*orm_gen.Favorite, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*orm_gen.Favorite, err error)
	FindInBatches(result *[]*orm_gen.Favorite, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*orm_gen.Favorite) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*orm_gen.Favorite, error)
	FirstOrCreate() (*orm_gen.Favorite, error)
	FindByPage(offset int, limit int) (result []*orm_gen.Favorite, count int64, err error)
...
func (f favoriteDo) Create(values ...*orm_gen.Favorite) error {
	if len(values) == 0 {
		return nil
	}
...
func (f favoriteDo) CreateInBatches(values []*orm_gen.Favorite, batchSize int) error {
	return f.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (f favoriteDo) Save(values ...*orm_gen.Favorite) error {
	if len(values) == 0 {
		return nil
	}
...
func (f favoriteDo) First() (*orm_gen.Favorite, error) {
	if result, err := f.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*orm_gen.Favorite), nil
	}
}

func (f favoriteDo) Take() (*orm_gen.Favorite, error) {
...
func (f favoriteDo) Last() (*orm_gen.Favorite, error) {
...
func (f favoriteDo) Find() ([]*orm_gen.Favorite, error) {
	result, err := f.DO.Find()
	return result.([]*orm_gen.Favorite), err
}

func (f favoriteDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*orm_gen.Favorite, err error) {
	buf := make([]*orm_gen.Favorite, 0, batchSize)
...
func (f favoriteDo) FindInBatches(result *[]*orm_gen.Favorite, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (f favoriteDo) FirstOrInit() (*orm_gen.Favorite, error) {
...
func (f favoriteDo) FirstOrCreate() (*orm_gen.Favorite, error) {
...
func (f favoriteDo) FindByPage(offset int, limit int) (result []*orm_gen.Favorite, count int64, err error) {
...
func (f favoriteDo) Delete(models ...*orm_gen.Favorite) (result gen.ResultInfo, err error) {

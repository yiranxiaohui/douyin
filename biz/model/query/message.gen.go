...
func newMessage(db *gorm.DB, opts ...gen.DOOption) message {
	...
	_message.messageDo.UseModel(&orm_gen.Message{})
...
type IMessageDo interface {
	...
	Unscoped() IMessageDo
	Create(values ...*orm_gen.Message) error
	CreateInBatches(values []*orm_gen.Message, batchSize int) error
	Save(values ...*orm_gen.Message) error
	First() (*orm_gen.Message, error)
	Take() (*orm_gen.Message, error)
	Last() (*orm_gen.Message, error)
	Find() ([]*orm_gen.Message, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*orm_gen.Message, err error)
	FindInBatches(result *[]*orm_gen.Message, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*orm_gen.Message) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*orm_gen.Message, error)
	FirstOrCreate() (*orm_gen.Message, error)
	FindByPage(offset int, limit int) (result []*orm_gen.Message, count int64, err error)
...
func (m messageDo) Create(values ...*orm_gen.Message) error {
	if len(values) == 0 {
		return nil
	}
...
func (m messageDo) CreateInBatches(values []*orm_gen.Message, batchSize int) error {
	return m.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (m messageDo) Save(values ...*orm_gen.Message) error {
	if len(values) == 0 {
		return nil
	}
...
func (m messageDo) First() (*orm_gen.Message, error) {
	if result, err := m.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*orm_gen.Message), nil
	}
}

func (m messageDo) Take() (*orm_gen.Message, error) {
...
func (m messageDo) Last() (*orm_gen.Message, error) {
...
func (m messageDo) Find() ([]*orm_gen.Message, error) {
	result, err := m.DO.Find()
	return result.([]*orm_gen.Message), err
}

func (m messageDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*orm_gen.Message, err error) {
	buf := make([]*orm_gen.Message, 0, batchSize)
...
func (m messageDo) FindInBatches(result *[]*orm_gen.Message, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (m messageDo) FirstOrInit() (*orm_gen.Message, error) {
...
func (m messageDo) FirstOrCreate() (*orm_gen.Message, error) {
...
func (m messageDo) FindByPage(offset int, limit int) (result []*orm_gen.Message, count int64, err error) {
...
func (m messageDo) Delete(models ...*orm_gen.Message) (result gen.ResultInfo, err error) {

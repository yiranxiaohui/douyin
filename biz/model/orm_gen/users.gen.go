...
type User struct {
	...
	FollowCount   int32  `gorm:"column:follow_count;not null" json:"follow_count"`     // 关注总数
	FollowerCount int32  `gorm:"column:follower_count;not null" json:"follower_count"` // 粉丝总数
